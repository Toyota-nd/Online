<?php
//C:\AppServ\www\cca\application\modules\campaign\models\EnrollmentMapper.php

class Campaign_Model_EnrollmentMapper{ 
   ...
   public function setDbTable($dbTable)
    ...
    public function getDbTable()
    {
        if (null === $this->_dbTable) {
            $this->setDbTable('Campaign_Model_DbTable_Enrollment');
        }
	...
	public function save(Campaign_Model_Enrollment $enrollment) { 

		$data = array(
		'campaign'=>$enrollment->getCampaign(),
	...
	public function find($enrollment_id, Campaign_Model_Enrollment $enrollment)
	{
	...
	public function fetchAll($values)
	{
	    ...
	    foreach ($resultSet as $row) {
	        $entry = new Campaign_Model_Enrollment();
	        $entry
			->setCampaign($row->campaign)
			->setEnrollment_id($row->enrollment_id)
			->setName($row->name)
