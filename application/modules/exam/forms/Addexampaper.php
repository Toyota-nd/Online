<?php
//C:\AppServ\www\cca\application\modules\campaign\forms\Addcampaign.php

class Exam_Form_Addexampaper extends ZendX_JQuery_Form{ 
	...
	public function init()
	{
	    ...
	    $this->setMethod('post');
	/*
	    $this->addElement('text', 'exampaper__name', array(
	    'decorators' => $this->genericDecorators,
		...
		$elem = new ZendX_JQuery_Form_Element_DatePicker('campaign__year', array(
